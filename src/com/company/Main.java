...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        LessonThreeLevelOneExcersiceFour threeLevelOneExcersiceFour = new LessonThreeLevelOneExcersiceFour();
        System.out.println("Write initial direction Robot <N>-North <E>-East <S>-South <W>-West ");
        do {
            direction = scanner.next();
            if (dir.contains(direction.toUpperCase())) {
                threeLevelOneExcersiceFour.showDirectionRobotAfterPushButton(direction);
